...
export class ManyResponseService {
	...
	question(question: string) {
		...
		// 	a.data
		// 	console.log(a.data.reduce((partialSum, a) => partialSum + a, 0));
		// 	console.log(b.data.reduce((partialSum, a) => partialSum + a, 0));
		...
		if (question == 'question43') this.bar = this.chartService.barH(this.title, "", this.xaxis, this.legend, this.series)
		else this.bar = this.chartService.bar(this.title, "", this.xaxis, this.legend, this.series)
